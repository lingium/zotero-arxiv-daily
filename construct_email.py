...
"""
    return block_template.format(title=title, authors=authors,rate=rate,arxiv_id=arxiv_id, abstract=abstract, pdf_url=pdf_url.replace('/pdf/', '/abs/'), code=code, affiliations=affiliations)
